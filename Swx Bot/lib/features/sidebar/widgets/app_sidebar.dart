...
import 'package:sol_bot/features/settings/widgets/help_modal.dart';
import 'package:sol_bot/features/settings/widgets/settings_modal.dart';
...
class _FooterBtnState extends State<_FooterBtn> {
  ...
  @override
  Widget build(BuildContext context) {
    // Add this line at the TOP of every widget's build method that needs it:
    final isLight = context.watch<SettingsProvider>().isLight;
    return MouseRegion(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.w800,
                fontSize: 16,
                color: isLight ? AppColors.lightText : AppColors.text,
              ),
            ),
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: widget.isActive
                ? AppColors.accent
                : _hovered
                ? (isLight ? AppColors.lightText : AppColors.text)
                : (isLight ? AppColors.lightText2 : AppColors.text2),
            borderRadius: BorderRadius.circular(10),
            border: Border.all(
              color: widget.isActive
