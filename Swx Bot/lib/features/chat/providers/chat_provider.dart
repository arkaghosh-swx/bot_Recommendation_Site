...
class ChatProvider extends ChangeNotifier {
  ...
  // Sound effect
  if (settings?.sound == true) _playPop();
...
void _playPop() {
  try {
    ...
    // Generates a soft beep using a short silence asset as fallback
    // Replace with: player.play(AssetSource('sounds/pop.mp3'));
    // For now it silently succeeds — sound infra is wired up
  } catch (_) {}
}
