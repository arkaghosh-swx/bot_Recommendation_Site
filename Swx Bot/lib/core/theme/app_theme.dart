...
class AppColors {
  ...
  static const Color lightSurface2 = Color(0xFFEDF4F0);
  static const Color lightSurface3 = Color(0xFFDDE8E4);
  static const Color lightBorder = Color(0xFFCCDDD7);
  static const Color lightBorder2 = Color(0xFFB8CEC8);
  static const Color lightText = Color(0xFF0D1F1A);
  static const Color lightText2 = Color(0xFF4A6B60);
}
  ...
  static ThemeData get light {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        primary: Color(0xFF2E6B5A),
        secondary: Color(0xFF22C55E),
        surface: Color(0xFFFFFFFF),
        error: Color(0xFFD66B6B),
      ),
      fontFamily: GoogleFonts.dmSans().fontFamily,
      textTheme: TextTheme(
        displayLarge: GoogleFonts.syne(
      ...
      appBarTheme: const AppBarTheme(
        ...
        iconTheme: IconThemeData(color: Color(0xFF4A6B60)),
      ),
      dividerColor: const Color(0xFFDDE8E4),
      dividerTheme: const DividerThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: const Color(0xFFEDF4F0),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFFCCDDD7)),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFFCCDDD7)),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFF2E6B5A), width: 1.5),
        ),
        hintStyle: GoogleFonts.dmSans(
          fontSize: 14.5,
          color: const Color(0xFF7A9E94),
        ),
        contentPadding: const EdgeInsets.symmetric(
          horizontal: 16,
          vertical: 12,
      ...
      scrollbarTheme: ScrollbarThemeData(
        thumbColor: WidgetStateProperty.all(const Color(0xFFCCDDD7)),
        thickness: WidgetStateProperty.all(3),
        radius: const Radius.circular(2),
      ),
      pageTransitionsTheme: const PageTransitionsTheme(
